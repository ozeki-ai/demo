...
<template>
  <div v-if="store.contractGenerated" class="relative w-[40rem] mx-auto my-10">
  ...
  <div v-if="!store.contractGenerated" class="max-w-7xl p-16">
    <div class="bg-white text-dark shadow sm:rounded-lg max-w-md">
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="mt-5">
          <div class="italic bg-warning-100 p-4 text-sm rounded-lg">The sales team have not yet generated your NDA.</div>
        </div>
      </div>
    </div>
  </div>
